...
public class LevenshteinDistanceFunction implements Function {
	...
	public static final String NAMESPACE = "http://www.sparna.fr/rdf4j/sesame/toolkit/functions#";

	/**
	 * return the URI 'http://www.sparna.fr/rdf/rdf4j/toolkit/functions#levenshtein' as a String
	 */
	@Override
